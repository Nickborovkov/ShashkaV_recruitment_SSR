<template>
  <div>
    <div class="header desctop flex-evenly">
      <contact-icons iconSize="20"/>

      <topbar-menu/>

      <div class="link">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-in-right"
             viewBox="0 0 16 16">
